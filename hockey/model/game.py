...
from hockey.derive.current_shift import current_shift_toi, current_shift_toi_series
...
class Game:
    ...
    def current_shift_toi(self, game_time: float, *, include_goalies: bool = False, reset_on_whistle: bool = False) -> dict:
